...
| Cross-replica active-capacity accounting (the shared lease registry, capacity scopes, and its error surface) | `.agent/docs/tech-software-spec.md` section 19.2 | `.agent/instructions/operations.md`, `.agent/instructions/security.md`, `.agent/instructions/project-map.md`, `.agent/instructions/validation.md` |
